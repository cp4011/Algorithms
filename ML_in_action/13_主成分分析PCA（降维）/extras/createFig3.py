...
ax.scatter(label0Mat[:, 0].tolist(), zeros(shape(label0Mat)[0]).tolist(), marker='^', s=90)
ax.scatter(label1Mat[:, 0].tolist(), zeros(shape(label1Mat)[0]).tolist(), marker='o', s=50,  c='red')
ax.scatter(label2Mat[:, 0].tolist(), zeros(shape(label2Mat)[0]).tolist(), marker='v', s=50,  c='yellow')
plt.show()
